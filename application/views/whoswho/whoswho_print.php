...
<div id="ww-nav" value="<?php echo $page; ?>" class="<?php echo $page; ?>">
	<ul class="nolist">
		<li id="ww-exec">
			<?php echo anchor('whoswho/print_profiles/exec', 'Exec'); ?>
		</li><li id="ww-assistants">
			<?php echo anchor('whoswho/print_profiles/assistants', 'Exec Officio & Assistants', 'class="nav-two-line"'); ?>
		</li><li id="ww-sports">
			<?php echo anchor('whoswho/print_profiles/sports', 'Sports Captains', 'class="nav-two-line"'); ?>
		</li><li id="ww-societies">
			<?php echo anchor('whoswho/print_profiles/societies', 'Society Presidents', 'class="nav-two-line"'); ?>
		</li><li id="ww-committees">
			<?php echo anchor('whoswho/print_profiles/committees', 'Committee Chairs', 'class="nav-two-line"'); ?>
		</li><li id="ww-support">
			<?php echo anchor('whoswho/print_profiles/support', 'Student Support', 'class="nav-two-line"'); ?>
		</li><li id="ww-services">
			<?php echo anchor('whoswho/print_profiles/services', 'Services'); ?>
		</li><li id="ww-staff">
			<?php echo anchor('whoswho/print_profiles/staff', 'College Staff'); ?>
		</li>
	</ul>
</div>
<div>
