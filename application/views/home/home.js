        ...
        init : function() {
            ...
            if($('.clock').length > 0){
                ...
                window.blink_interval = setInterval(function(){
                    if($('.colon').css('color') == 'rgb(200, 0, 0)'){
                        $('.colon').css('color', 'white');
                    }else{
                        $('.colon').css('color', '#c80000')
                    }
                }, 1000);
                //
            }
            ...
            window.poster_timeout_handle = setInterval(function(){
                if($('.poster-box').children('.poster-image').length == 0){
                    ...
                    $('.poster-box').animate(
                        {
                            left: (-$('.poster-image .event-scroll-image').first().width() - 7)+'px'
                        }, 
                        {
                            duration: 400,
                            complete: function(){
                                $('.poster-box').children('.poster-image').first().remove(); $('.poster-box').css('left','0px');
                            }
                        }
                    );
                }
