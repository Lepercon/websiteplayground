...
<div class="content-left width-33 narrow-full">
	<div class="jcr-box wotw-outer">
		<h2 class="wotw-day">Checkout</h2>
		<div class="padding-box">
			<?php echo editable_area('charities', 'content/basket', $access_rights); ?>
			<a href="<?php echo site_url('charities/checkout'); ?>" class="jcr-button inline-block" title="Checkout">
				<span class="ui-icon ui-icon-cart inline-block"></span>Confirm Order
			</a>
		</div>
	</div>
</div>
	...
	<div class="jcr-box wotw-outer">
		...
		<div class="padding-box">
			<?php if($this->cart->total_items() > 0) {
				echo form_open('charities/submit_form/basket', array('class' => 'jcr-form')); ?>
				<table>
