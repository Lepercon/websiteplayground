...
?>
    <div class="jcr-box wotw-outer">
        <a href="<?php echo site_url('ballot/view/'.$b['id'].'/'.(is_null($b['signup_name'])?url_title($b['name']):url_title($b['name'].'-'.$b['signup_name']))); ?>"><h3 class="wotw-day"><?php echo (is_null($b['signup_name'])?$b['name']:$b['name'].' - '.$b['signup_name']); ?></h3></a>
        <div>
