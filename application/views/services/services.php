...
<div class="width-66 narrow-full content-left">
    ...
    if(logged_in()){ 
     ?>
        <div class="jcr-box wotw-outer">
            <h3 class="wotw-day">Anonymous JB's Requests/Feedback</h3>
    ...
    <div class="jcr-box wotw-outer">
        ...
        <?php $this->load->view('utilities/users_contact', array('level_ids'=>array(131,148,150,130))); ?>
    </div>
</div>
<div class="content-right width-33 narrow-full">
    <div class="jcr-box wotw-outer">
        ...
        <?php $this->load->view('utilities/users_contact', array('level_ids'=>array(17, 8))); ?>
    </div>
</div>