...
$js_urls = array(
	'jquery' => (ENVIRONMENT == 'local' ? 'http://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js' : 'http'.(HTTPS ? 's' : '').'://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js'),
	'jquery_ui' => (ENVIRONMENT == 'local' ? 'http://ajax.googleapis.com/ajax/libs/jqueryui/1.10.3/jquery-ui.min.js' : 'http'.(HTTPS ? 's' : '').'://ajax.googleapis.com/ajax/libs/jqueryui/1.10.3/jquery-ui.min.js'),
